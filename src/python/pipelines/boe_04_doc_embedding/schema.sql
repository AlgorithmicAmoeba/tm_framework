...
-- Index for chunk count filtering
CREATE INDEX IF NOT EXISTS idx_boe_document_embedding_chunk_count
    ON pipeline.boe_document_embedding(corpus_name, target_chunk_count);
