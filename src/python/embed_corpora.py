...
from hf_embedder import embed_texts  # Assuming this is the correct import for the embedding function
...
def embed_corpora():
    ...
    with database.get_session(db_config) as session:
        ...
        for corpus in corpuses:
            ...
            # Embed the raw texts
            embeddings = embed_texts(raw_texts)  # Assuming this function returns a list of embeddings
